...
|------|-------------|-------------|------|
| 测试1 | 1.0.1-1 | 29 | 编译安装验证（本地Git commit） |
| 测试2 | 1.0.1-2 | 30 | 编译安装验证（本地Git commit） |
| 测试3 | 1.0.1-3 | 31 | 编译安装验证（本地Git commit） |
| 正式发布 | 1.0.1 | 31 | 编译+安装+推Git+Release |
...
> - 铁律15：原铁律13（全程适配语言）平移
> - 版本号说明：测试版改为"不发远程，仅本地commit"
> - 测试流程：改为只本地commit + archive，去掉发远程/Release
> - 正式流程：拆出⑩提交本地Git和⑪推远程
> - 第7节：拆分为7.1本地Git、7.2远程Git、7.3 Release、7.4 archive
> - 合并自网关指南（v18）的改进
